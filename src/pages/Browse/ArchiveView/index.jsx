        ...
        <ResponsiveDrawer>
            ...
            <div className='flex mt-2'>
                <Box style={{ width: "60%", marginRight: "30px"}}>
                    ...
                    <p><span className='inline-text-decor'>First Published</span>: <Moment format="DD MMMM YYYY">{document.publicationDate}</Moment> | <span className='inline-text-decor'>Publication Year:</span> {document.schoolYear} | <span className='inline-text-decor'>Citations:</span> {document.citations.length}</p>
